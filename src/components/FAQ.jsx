const FAQS = [
  ...
  },
  {
    ...
    a: 'We meet at the basketball courts at 35th and Atlantic in Longport. From there we use the courts, the gazebo for shade, and the beach itself. Specific drop-off details are sent to all registered families before each session.',
  },
  {
