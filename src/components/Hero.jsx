  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1200px]">
        ...
        >
          ★ Margate &amp; Longport, NJ ★ Summer 2026
        </span>
        ...
        <p className="mb-9 max-w-[580px] text-[clamp(18px,2.2vw,22px)] font-medium text-ink">
          A drop-off beach camp for ages 4–9, run by two certified PE teachers. Sports, games, arts &amp; crafts, water games, and full-on field-day energy — all on the sand.
        </p>
        <div className="mb-12 flex flex-wrap gap-4">
          <a href={REGISTER_URL} className="btn-primary">Register Your Child →</a>
